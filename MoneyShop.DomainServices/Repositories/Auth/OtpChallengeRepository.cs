...
public class OtpChallengeRepository : BaseRepository<OtpChallenge>, IOtpChallengeRepository
{
    public OtpChallengeRepository(MoneyShopDbContext context) : base(context)
    {
    }
}
