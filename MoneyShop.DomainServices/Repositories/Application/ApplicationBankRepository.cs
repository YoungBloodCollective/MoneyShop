...
public class ApplicationBankRepository : BaseRepository<ApplicationBank>, IApplicationBankRepository
{
    public ApplicationBankRepository(MoneyShopDbContext context) : base(context)
    {
    }
}
